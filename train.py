"""
Training SVM Model untuk Deteksi Myocardial Infarction
...
def extract_features(record_path, fs_target=100):
    """
...
ax.set_title('Feature Distribution (Before Normalization)')
ax.legend()
...
ax.set_title('Feature Distribution (After Z-Score Normalization)')
ax.legend()
ax.grid(True, alpha=0.3)
